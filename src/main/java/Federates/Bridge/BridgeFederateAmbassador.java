 ...
 * {@link BridgeFederate}. It will log information about any callbacks it
 * receives, thus demonstrating how to deal with the provided callback information.
 */
public class BridgeFederateAmbassador extends NullFederateAmbassador
{
    //----------------------------------------------------------
    //                    STATIC VARIABLES
    //----------------------------------------------------------
    ...
    //                   INSTANCE VARIABLES
    //----------------------------------------------------------
    private BridgeFederate federate;
    ...
    public BridgeFederateAmbassador(Federates.Bridge.BridgeFederate federate )
    {
    ...
    public void announceSynchronizationPoint( String label, byte[] tag )
    {
        ...
        if( label.equals(BridgeFederate.READY_TO_RUN) )
            ...
            throws FederateInternalError
    {
        ...
        if( interactionClass.equals(federate.IEnteredTheBridge) )
        {
            builder.append( " (I AM THE STORM THAT IS APPROAAAAAAAAACHING)" );
        }

        if( interactionClass.equals(federate.ILeftTheBridge) )
        {
            builder.append( " (I AM THE STORM THAT IS LEAVING)" );
        }
